...
class CertificadosController extends Controller
{
	...
	{
		$model=Certificados::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Certificados $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='certificados-form')
		{
